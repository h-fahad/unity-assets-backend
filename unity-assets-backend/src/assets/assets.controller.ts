...
export class AssetsController {
  ...
  async findAll(
    ...
    return this.assetsService.findAll(categoryIdNum, pageNum, limitNum, shouldIncludeInactive);
  }
  ...
  async getAssetsByCategory(
    ...
    return this.assetsService.getAssetsByCategory(categoryId, pageNum, limitNum);
  }
  ...
  async create(
    ...
    const assetFile = files.assetFile?.[0]?.filename;
    ...
    return this.assetsService.create(
      {
        ...
        fileUrl: assetFile ? `/uploads/${assetFile}` : '',
      },
      userId,
    );
  }
